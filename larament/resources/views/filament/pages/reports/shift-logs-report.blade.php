<x-filament-panels::page>
    ...
    <div class="space-y-6">
        <!-- Filter Form -->
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 no-print border border-gray-200 dark:border-gray-700">
            {{ $this->form }}
        </div>

        <!-- Shift Info -->
        @if ($selectedShiftInfo)
            <div class="bg-blue-50 dark:bg-blue-900 border-l-4 border-blue-400 dark:border-blue-500 p-4 rounded">
                <div class="flex">
        ...
        @if (count($logEntries) > 0)
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                ...
                <div
                    class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 border-l-4 border-{{ $errorCount > 0 ? 'red' : 'gray' }}-500">
                    <div class="flex items-center gap-2">
                    ...
                    @foreach ($logEntries as $entry)
                        <div class="p-6 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
                            <div class="flex items-start space-x-4 space-x-reverse">
                                ...
                                <div class="flex-shrink-0">
                                    <div
                                        class="w-10 h-10 rounded-full flex items-center justify-center {{ $this->getLogLevelClass($entry['level']) }} shadow-sm">
                                        @php
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <div class="flex items-start justify-between mb-2">
                                        ...
                                        <div class="flex flex-col items-end space-y-1">
                                            ...
                                            <span
                                                class="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold {{ $this->getLogLevelClass($entry['level']) }} shadow-sm">
                                                @switch($entry['level'])
                                                    @case('error')
                                                        خطأ
                                                    @break
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <x-dynamic-component :component="$typeIcon"
                                                                            class="w-5 h-5 mt-0.5 {{ $typeColor }} flex-shrink-0" />
                                                                        <div class="flex-1">
                                                                            <p
                                                                        ...
                                                                        <div class="space-y-1 text-xs">
                                                                            <div class="flex space-x-2 space-x-reverse">
                                                                                <span
                                                                                    ...
                                                                                    السابقة:</span>
                                                                                <span
                                                                                    class="text-gray-800 dark:text-gray-200 bg-red-50 dark:bg-red-900 px-2 py-1 rounded">
                                                                            ...
                                                                            <div class="flex space-x-2 space-x-reverse">
                                                                                <span
                                                                                    ...
                                                                                    الجديدة:</span>
                                                                                <span
                                                                                    class="text-gray-800 dark:text-gray-200 bg-green-50 dark:bg-green-900 px-2 py-1 rounded">
