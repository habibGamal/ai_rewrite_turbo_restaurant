                ...
                <div class="prose dark:prose-invert max-w-none">
                    <ul class="text-sm space-y-2 text-gray-600 dark:text-gray-400">
                        <li class="flex items-start gap-2">
                            <x-heroicon-m-arrow-path class="w-4 h-4 text-primary-500 mt-0.5 flex-shrink-0" />
                            <span>استخدم زر "تحديث البيانات" لجلب أحدث المنتجات والأسعار والوصفات من النقطة الرئيسية</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <x-heroicon-m-plus class="w-4 h-4 text-success-500 mt-0.5 flex-shrink-0" />
                            <span>اختر المنتجات التي تريد استيرادها من قائمة "المنتجات الجديدة"</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <x-heroicon-m-currency-dollar class="w-4 h-4 text-warning-500 mt-0.5 flex-shrink-0" />
                            <span>اختر المنتجات التي تريد تحديث أسعارها من قائمة "الأسعار المتغيرة"</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <x-heroicon-m-squares-2x2 class="w-4 h-4 text-info-500 mt-0.5 flex-shrink-0" />
                            <span>اختر المنتجات التي تريد تحديث وصفاتها من قائمة "الوصفات المتغيرة"</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <x-heroicon-m-signal class="w-4 h-4 text-info-500 mt-0.5 flex-shrink-0" />
