      ...
      <table className="mt-4 w-full table-fixed border-collapse border-solid border border-black">
        <tbody>
          ...
          <tr>
            ...
            <td className="p-2 py-4 border border-solid border-black">{order.tax.toFixed(2)}</td>
          </tr>
          <tr>
            <td className="p-2 py-4 border border-solid border-black">الاجمالي النهائي</td>
            <td className="p-2 py-4 border border-solid border-black">{order.total.toFixed(2)}</td>
          </tr>
        </tbody>
      </table>
      <p className="text-center">الرقم المرجعي - {order.id}</p>
